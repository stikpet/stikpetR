...
#' 
#' van de Wiel, M. A., & Bucchianico, A. D. (2001). Fast computation of the exact null distribution of Spearman’s ρ and Page’s L statistic for samples with and without ties. *Journal of Statistical Planning and Inference, 92*(1–2), 133–145. https://doi.org/10.1016/S0378-3758(00)00166-X
#' 
#' @author 
#' P. Stikker
#' 
...
#' rs = 0.8
#' di_spearman(n, rs)
#' di_spearman(n, rs, method="exact")
#' di_spearman(n, rs, method="t")
#' di_spearman(n, rs, method="z-fieller")
#' di_spearman(n, rs, method="z-olds")
#' di_spearman(n, rs, method="iman-conover")
