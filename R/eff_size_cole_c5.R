...
#' \deqn{C_5 = \frac{\sqrt{2}\times\left(a\times d - b\times c\right)}{\sqrt{\left(a\times d - b\times c\right)^2 + R_1\times R_2\times C_1\times C_2}}}
#' 
#' *Symbols used:*
#' \itemize{
...
#' es_cole_c5(df1[['mar1']], df1[['sex']], categories1=c("WIDOWED", "DIVORCED"))
#' 
#' @export
