...
#' ts_pearson_ind(nom1, nom2)
#' ts_pearson_ind(nom1, nom2, cc="yates")
#' ts_pearson_ind(nom1, nom2, cc="pearson")
#' ts_pearson_ind(nom1, nom2, cc="williams")
#'  
#' @export
ts_pearson_ind <- function(nom1, nom2, cc=NULL){
