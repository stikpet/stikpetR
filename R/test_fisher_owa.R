...
#' 
#' Pitman, E. J. G. (1938). Significance tests which may be applied to samples from any populations: III The analysis of variance test. *Biometrika, 29*(3–4), 322–335. https://doi.org/10.1093/biomet/29.3-4.322
#' 
#' @author 
#' P. Stikker
#' 
...
#' 
#' @export
ts_fisher_owa <- function(scores, groups){
