...
#' 
#' There are quite some alternatives for this, the stikpet library has Welch, James, Box, Scott-Smith, Brown-Forsythe, Alexander-Govern, Mehrotra modified Brown-Forsythe, Hartung-Agac-Makabi, Ozdemir-Kurt and Wilcox as options. See the notes for some discussion on the differences.
#' 
...
#' 
#' Cavus and Yazici (2020) compared many different tests. They showed that the Brown-Forsythe, Box correction, Cochran, Hartung-Agac-Makabi adjusted Welch, and Scott-Smith test, all do not perform well, compared to the Asiribo-Gurland correction, Alexander-Govern test, Ozdemir-Kurt B2, Mehrotra modified Brown-Forsythe, and Welch.
#' 
...
#' 
#' Besides these, there are more methods, some using simulation (bootstrapping) (see Cavus and Yazici (2020) for a few of them), others using different techniques (see Yigit and Gokpinar (2010) for a few more methods not in here).
#' 
#' @references 
...
#' 
#' Hartung, J., Argac, D., & Makambi, K. H. (2002). Small sample properties of tests on homogeneity in one-way anova and meta-analysis. *Statistical Papers, 43*(2), 197-235. doi:10.1007/s00362-002-0097-8
#' 
...
#' 
#' Yigit, E., & Gokpinar, F. (2010). A simulation study on tests for one-way ANOVA under the unequal variance assumption. Communications, Faculty Of Science, University of Ankara, 15-34. doi:10.1501/Commua1_0000000660
#' 
#' @author 
